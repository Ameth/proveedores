    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
          <!-- InstanceBeginEditable name="EditRegion3" -->
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Orden de compra: <?php echo $rowOC['DocNum'];?></h3>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <!-- InstanceBeginEditable name="EditRegion6" -->
             <div class="row">
            <div class="col-lg-2">
				<button class="btn btn-outline btn-primary" onClick="javascript:location.href='ordenes_compra.php'"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Regresar</button>
			</div>
		  </div>
		  <div class="row">&nbsp;</div>
            <!-- InstanceEndEditable -->            
